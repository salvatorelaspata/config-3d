	...
	return (
		<ol className="inline-flex items-center justify-end space-x-1 md:space-x-3">
			<li className="inline-flex items-center">
				<Link
					to="/"
					className="inline-flex items-center text-sm font-mono text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
				>
					<svg
			...
			<li
				className={
					pathname !== "/catalog" && pathname !== "/configurator" && "hidden"
				}
			>
