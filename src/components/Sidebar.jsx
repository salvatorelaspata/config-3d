...
function Sidebar() {
	var mobileNavRef = useRef().current;
	// sideBar.style.transform = "translateX(-260px)";
	const [isOpen, setIsOpen] = useState(true);
	function sidebarHandler() {
		if (isOpen) {
			mobileNavRef.style.transform = "translateX(0px)";
		} else {
			mobileNavRef.style.transform = "translateX(-260px)";
		}
		setIsOpen(!isOpen);
	}
	return (
			...
			<div className="flex flex-no-wrap">
				...
				>
					<button
						...
						className={`${
							isOpen && "hidden"
						} h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800`}
